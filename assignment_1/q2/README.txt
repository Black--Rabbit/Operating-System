...
BUGS:
	...
	The output is different at times for the same input. The buffer is creating some problem which I was not able to resolve. 
	
	Had put fflush most of the places the over come the above problem. 
